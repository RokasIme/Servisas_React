    ...
    <div className="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
      ...
      >
        ...
        <div className="offcanvas-body d-md-flex flex-column p-3 pt-lg-3 overflow-y-auto">
          ...
          <ul className="nav nav-pills flex-column">
            <li className="nav-item">
              <Link to="/admin/masters/new" className="nav-link d-flex align-items-center gap-2">
                Add new
              </Link>
            </li>
            <li className="nav-item">
              <Link to="/admin/masters" className="nav-link d-flex align-items-center gap-2">
                All masters
              </Link>
            </li>
            <li className="nav-item">
              <Link to="/admin/masters/published" className="nav-link d-flex align-items-center gap-2">
                Published masters
              </Link>
            </li>
            <li className="nav-item">
              <Link to="/admin/masters/draft" className="nav-link d-flex align-items-center gap-2">
                Draft masters
              </Link>
            </li>
          </ul>
          ...
          <ul className="nav nav-pills flex-column">
            <li className="nav-item">
              <Link to="/admin/workshops/new" className="nav-link d-flex align-items-center gap-2">
                Add new
              </Link>
            </li>
            <li className="nav-item">
              <Link to="/admin/workshops" className="nav-link d-flex align-items-center gap-2">
                All workshops
              </Link>
            </li>
          </ul>
